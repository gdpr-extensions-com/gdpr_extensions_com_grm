...
use GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\MapLocation;
...
class GdprManagerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function listAction(): \Psr\Http\Message\ResponseInterface
    {
        ...
        $tiktokData = $this->gdprManagerRepository->findByExtension_key('gdpr_extensions_com_grm')->toArray();
        return $this->redirect('edit',null,null,['gdprManager' => $tiktokData[0]]);
     ...
     * action show
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $gdprManager
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function showAction(\GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * action create
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $newGdprManager
     */
    public function createAction(\GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $newGdprManager)
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function editAction(\GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function updateAction(\GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $gdprManager) : \Psr\Http\Message\ResponseInterface
    {
        if($this->request->hasArgument('tx_GdprTwoXGreviewMasonry_web_GdprTwoXGreviewMasonrygdprmanager')){
            $locationsData = $this->request->getArgument('tx_GdprTwoXGreviewMasonry_web_GdprTwoXGreviewMasonrygdprmanager')['locations'];
        }
     ...
     * @param \GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $gdprManager
     */
    public function deleteAction(\GdprExtensionsCom\GdprExtensionsComGrm\Domain\Model\GdprManager $gdprManager)
    {
